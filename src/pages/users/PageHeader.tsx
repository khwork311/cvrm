  ...
  return (
    <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 sm:text-3xl dark:text-white/90">{t('users:title')}</h1>
          <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">{t('users:subtitle')}</p>
        </div>
      ...
      <div className="flex flex-wrap justify-center gap-3 lg:flex-row lg:items-center">
        <div className="relative w-full sm:w-auto">
          <input
            ...
            className="focus:ring-brand-500/20 h-10 w-full rounded-lg border border-gray-300 bg-white px-4 pr-10 text-sm text-gray-800 placeholder:text-gray-500 focus:border-blue-500 focus:ring-4 focus:outline-none sm:w-64 dark:border-gray-600 dark:bg-gray-800 dark:text-white/90 dark:placeholder:text-gray-400 dark:focus:border-blue-400"
          />
