...
import { CustomerInvitationRegister } from './pages/customers/CustomerInvitationRegister';
...
const ContactPersons = lazy(() =>
  import('@/pages/companies/ContactPersons').then((m) => ({ default: m.ContactPersons }))
);
...
const CustomerGroupsList = lazy(() =>
  import('@/pages/customer-groups/CustomerGroupsList').then((m) => ({ default: m.CustomerGroupsList }))
);
const CreateCustomerGroup = lazy(() =>
  import('@/pages/customer-groups/CustomerGroupForm').then((m) => ({ default: m.CreateCustomerGroup }))
);
const GroupCustomers = lazy(() =>
  import('@/pages/customer-groups/GroupCustomers').then((m) => ({ default: m.GroupCustomers }))
);
const AssignCustomer = lazy(() =>
  import('@/pages/customer-groups/AssignCustomer').then((m) => ({ default: m.AssignCustomer }))
);
...
const SendInvitation = lazy(() =>
  import('@/pages/vendors/SendInvitation').then((m) => ({ default: m.SendInvitation }))
);
const AcceptInvitation = lazy(() =>
  import('@/pages/vendors/AcceptInvitation').then((m) => ({ default: m.AcceptInvitation }))
);
const CompleteProfile = lazy(() =>
  import('@/pages/vendors/CompleteProfile').then((m) => ({ default: m.CompleteProfile }))
);

// Lazy load vendor group pages
const VendorGroupsList = lazy(() =>
  import('@/pages/vendor-groups/VendorGroupsList').then((m) => ({ default: m.VendorGroupsList }))
);
const VendorGroupForm = lazy(() =>
  import('@/pages/vendor-groups/VendorGroupForm').then((m) => ({ default: m.VendorGroupForm }))
);
const AssignVendor = lazy(() =>
  import('@/pages/vendor-groups/AssignVendor').then((m) => ({ default: m.AssignVendor }))
);
          ...
          <SWRConfig value={swrConfig}>
            ...
            <Suspense fallback={<PageLoader />}>
              <Routes>
                ...
                <Route path="/customer-register" element={<CustomerInvitationRegister />} />
